...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\columnwidth]{../project/artifacts/latest_metric_summary.png}
    \caption{Latest metric summary (PR / ROC and operating diagnostics) from the most recent validated run.}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\columnwidth]{../project/artifacts/latest_metric_summary.png}
    \caption{Benchmarking results and the latest validated model comparison (see artifact images).}
\end{figure}
...
\midrule
Optimized Hybrid & 0.7750 & 0.960122 & \textcolor{techblue}{🥇 Grand Champion} \\
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\columnwidth]{../project/artifacts/latest_roc_curve.png}
    \vspace{4pt}
    \includegraphics[width=0.95\columnwidth]{../project/artifacts/latest_pr_curve.png}
    \caption{ROC (top) and PR (bottom) curves for the latest validated Champion model.}
\end{figure}
