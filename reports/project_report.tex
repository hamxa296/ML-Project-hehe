...
\begin{figure*}[t]
 ...
 \caption{Complete system architecture showing CI/CD, orchestration, model registry, and serving layers with cleaner, production-quality layout.}
\end{figure*}
...
\begin{figure*}[t]
 \centering
 \begin{tabular}{cc}
  \includegraphics[width=0.46\textwidth]{assets/eda_class_imbalance.png} &
  \includegraphics[width=0.46\textwidth]{assets/eda_amounts.png} \\
  \includegraphics[width=0.46\textwidth]{assets/eda_correlation.png} &
  \includegraphics[width=0.46\textwidth]{assets/eda_temporal.png}
 \end{tabular}
 \caption{Actual EDA outputs from the project: class balance, transaction amount behavior, feature correlation structure, and temporal fraud patterns.}
\end{figure*}
...
\begin{figure*}[t]
\centering
\includegraphics[width=0.95\textwidth]{assets/methodology_flow.png}
\caption{End-to-end machine learning methodology from raw data to evaluation, using the actual project workflow graphic.}
\end{figure*}
...
\begin{figure*}[t]
 ...
 \\caption{Model comparison and benchmark context rendered from the project's generated evaluation artifact.}
\\end{figure*}
\centering
\begin{tikzpicture}
	\begin{axis}[
...
\begin{figure*}[t]
 \\centering
 \\includegraphics[width=0.95\\textwidth]{assets/prefect_orchestration.png}
 \\caption{Operational run order and orchestration flow used during model training and retraining.}
\\end{figure*}
...
\begin{figure*}[t]
 \centering
 \includegraphics[width=0.95\textwidth]{assets/prefect_orchestration.png}
 \caption{Prefect orchestration flow for model training and validation, rendered from the generated project asset.}
\end{figure*}
...
\begin{figure*}[t]
 \centering
 \includegraphics[width=0.95\textwidth]{assets/containerization_workflow.png}
 \caption{The end-to-end run order used by Prefect and the training pipeline, shown with the generated orchestration workflow graphic.}
\end{figure*}
...
\begin{figure*}[t]
 \centering
 \includegraphics[width=0.95\textwidth]{assets/model_comparison.png}
 \caption{Paper benchmark context versus current run summary, rendered from the generated model comparison artifact.}
\end{figure*}
\begin{itemize}
